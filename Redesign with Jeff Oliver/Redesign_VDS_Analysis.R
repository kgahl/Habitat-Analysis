...
##Assign combination of variables     
  #Iterate over each row of Variable_Combos                                       #assigns a name to the selected variable from the selected row   
...
##Filter occupied and available data by stream and species
  ...
  Unique_Individuals <- length(Unique_Fish[!is.na(Unique_Fish)])              #removes NA 
  #Number of Observed
