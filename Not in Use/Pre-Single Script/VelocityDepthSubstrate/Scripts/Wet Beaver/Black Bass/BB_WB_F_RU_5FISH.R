...
#Only Spawning period- Sept - Nov and Runs                                #[5 Black Bass observations, 26  available]
BB_WB_F_RU <- BB_AV_WB %>%
...
Unique_Fish <- na.omit(unique(BB_WB_F_RU$Tag))                               #Gives number of individuals- doesn't count the same fish more than once
...
MinMax <- data.frame(DataSet = "BB_WB_F_RU", Velocity_Min, Velocity_Max, Depth_Min, 
