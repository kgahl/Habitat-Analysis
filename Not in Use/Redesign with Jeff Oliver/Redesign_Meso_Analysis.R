...
Variable_Combos <- read.csv("HighLow Discharge/HighLowMesohabitat_Variables.csv")
...
##### RESOURCE RATIOS #####
    ...
    #   Used_Prob_Pool<- sum(na.omit(Used_Pool)/sum(na.omit(Used_Data_i$StreamWidth)))
    #   Storage$Ratio_Pool[i] <- Used_Prob_Pool/Avail_Prob_Pool
    #   
    #   #Riffle
    #   Avail_Riffle <- ifelse(Avail_Data$Mesohabitat == 'Riffle', (na.omit(Avail_Data$StreamWidth)),0)
    ...
    #   Used_Prob_Riffle<- sum(na.omit(Used_Riffle)/sum(na.omit(Used_Data_i$StreamWidth)))
    #   Storage$Ratio_Riffle[i] <- Used_Prob_Riffle/Avail_Prob_Riffle
    #   
    #   #Run
    #   Avail_Run <- ifelse(Avail_Data$Mesohabitat == 'Run', (na.omit(Avail_Data$StreamWidth)),0)
    ...
    #   Used_Prob_Run <- sum(na.omit(Used_Run)/sum(na.omit(Used_Data_i$StreamWidth)))
    #   Storage$Ratio_Run[i] <- Used_Prob_Run/Avail_Prob_Run
